...
SWIFT_CLASS("_TtC14speech_to_text23SwiftSpeechToTextPlugin") SWIFT_AVAILABILITY(ios,introduced=10.0)
...
@interface SwiftSpeechToTextPlugin (SWIFT_EXTENSION(speech_to_text)) <AVAudioPlayerDelegate>
...
SWIFT_AVAILABILITY(ios,introduced=10.0)
@interface SwiftSpeechToTextPlugin (SWIFT_EXTENSION(speech_to_text)) <SFSpeechRecognizerDelegate>
...
SWIFT_AVAILABILITY(ios,introduced=10.0)
@interface SwiftSpeechToTextPlugin (SWIFT_EXTENSION(speech_to_text)) <SFSpeechRecognitionTaskDelegate>
